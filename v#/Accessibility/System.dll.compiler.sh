...
find . -name *.vala -type f -print | xargs valac  --pkg gee-1.0   --library libAccessibility  --vapi "libAccessibility.vapi"  -H "libAccessibility.h"  -o libAccessibility.so  -X -fPIC -X --share
